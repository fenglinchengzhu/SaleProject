...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void startRefresh(Context context) {
        mHeaderView.setVisiableHeight(dip2px(context, 70));
        mScrollBack = SCROLLBACK_HEADER;
        mScroller.startScroll(0, 0, 0, dip2px(context, 70), SCROLL_DURATION);
        invalidate();
        ...
        mScroller.startScroll(0, dip2px(context, 70), 0, -(dip2px(context, 10)), SCROLL_DURATION);
        invalidate();
    }
