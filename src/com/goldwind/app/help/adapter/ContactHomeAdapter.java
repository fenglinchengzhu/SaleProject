...
import com.goldwind.app.help.util.HanziToPinyin;
...
public class ContactHomeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (0 == cb.getPhotoId()) {
            holder.qcb.setImageResource(R.drawable.default_icon);
        } else {
    ...
    private String getAlpha(String str) {
        ...
        if (Character.isDigit(str.charAt(0))) {
            ...
            String header = HanziToPinyin.getPingYin(str)
                    .toUpperCase();
            char ala = header.toLowerCase().charAt(0);
            if (ala < 'a' || ala > 'z') {
                return "#";
            }
            return ala + "";
