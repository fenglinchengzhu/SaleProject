...
import com.goldwind.app.help.fragment.SimpleCalculatorInputFragment;
 ...
 */
public class CalculatorInputActivity extends BaseFragmentActivity {
    boolean isALL = true;
    ...
    SimpleCalculatorInputFragment mCalculatorInputAllFragment;
        ...
        switch (tag) {
            case Constant.TAB.CAL_ALL:
                if (mCalculatorInputAllFragment == null)
                    mCalculatorInputAllFragment = new SimpleCalculatorInputFragment();
