 ...
 */
public class CalculatorOutPutActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mParas = getIntent().getStringExtra("params");
