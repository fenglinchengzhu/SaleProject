...
public class Util {
    ...
    public static void initS3Client(String accessKeyID, String secretKey, String bucketName) {
        sS3Client = new AmazonS3Client(
                new BasicAWSCredentials(accessKeyID,
                        secretKey));
        Log.d("yao", accessKeyID + "--" + secretKey + "--" + bucketName);
        AwsJinFengDownloadService.bucketName = bucketName;
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            String accessKeyID = CommonUtil.spGetString(context, "accessKeyID");
            String secretKey = CommonUtil.spGetString(context, "secretKey");
            sS3Client = new AmazonS3Client(
                    new BasicAWSCredentials(accessKeyID,
                            secretKey));
            sS3Client.setRegion(Region.getRegion(Regions.CN_NORTH_1));
